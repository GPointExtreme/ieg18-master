...
namespace BlackFriday.Controllers
{
    ...
    {
        private static readonly string productsArrayServiceBaseAddress = "http://productsarray.azurewebsites.net/";
    ...
    [Route("api/getFile")]
    //http://blackfriday.azurewebsites.net/api/getFile
    public class ProductListFileController : Controller
    {
        private static readonly string fileArrayServiceBaseAddress = "http://productsfile.azurewebsites.net/";
