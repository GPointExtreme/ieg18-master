...
namespace BlackFriday.Controllers
{
    ...
    public class PaymentMethodsController : Controller
    {
        ...
        public async Task<IEnumerable<string>> Get()
        {
          ...
          //  var client = _clientFactory.CreateClient("http://easycreditcardservice1.azurewebsites.net/");


            var client = _clientFactory.CreateClient("http://127.0.0.1:7777/");
        ...
        private async Task<HttpResponseMessage> failedCircuit(BrokenCircuitException exception) {
            ...
            var client = _clientFactory.CreateClient("http://127.0.0.1:7778/");
